...
const translations = [
  ...
  // Species detail pages (intro sections)
  ['How do we help with your poultry ?', 'Comment aidons-nous votre activité avicole ?'],
  ['VeritasVet supports poultry producers with practical and cost-efficient nutritional strategies adapted to breeders, broilers and layers.', 'VeritasVet accompagne les producteurs avicoles avec des stratégies nutritionnelles pratiques et rentables, adaptées aux reproducteurs, aux poulets de chair et aux pondeuses.'],
  ['Our approach focuses on improving feed efficiency, stabilizing gut health, reducing mycotoxin impact and optimizing metabolic performance to enhance productivity and final product quality.', 'Notre approche vise à améliorer l\'efficacité alimentaire, stabiliser la santé intestinale, réduire l\'impact des mycotoxines et optimiser les performances métaboliques afin d\'améliorer la productivité et la qualité finale du produit.'],
  ['Rather than proposing generic programs, our technical specialists analyze farm conditions, production targets and feed formulation constraints to recommend the most suitable additive and premix solutions.', 'Plutôt que de proposer des programmes génériques, nos spécialistes techniques analysent les conditions d\'élevage, les objectifs de production et les contraintes de formulation pour recommander les solutions d\'additifs et de prémélanges les plus adaptées.'],
  ['Each production stage requires a different nutritional approach. Our team works closely with partners and integrators to select the optimal solution for performance, safety and economic efficiency', 'Chaque phase de production nécessite une approche nutritionnelle spécifique. Notre équipe travaille en étroite collaboration avec les partenaires et les intégrateurs afin de sélectionner la solution optimale en matière de performance, de sécurité et d\'efficacité économique.'],
  ['How we support ruminant performance', 'Comment nous soutenons la performance des ruminants'],
  ['VeritasVet assists dairy and beef producers with practical nutritional strategies designed to stabilize rumen function and improve production efficiency under real farm conditions.', 'VeritasVet accompagne les producteurs laitiers et bovins avec des stratégies nutritionnelles pratiques conçues pour stabiliser la fonction ruminale et améliorer l\'efficacité de production dans des conditions d\'élevage réelles.'],
  ['Our approach focuses on optimizing rumen fermentation, supporting calf development and maintaining digestive balance throughout all production stages. Particular attention is given to mitigating the impact of mycotoxins, improving young animal robustness and maintaining feed intake consistency in adult animals.', 'Notre approche se concentre sur l\'optimisation de la fermentation ruminale, le soutien du développement des veaux et le maintien de l\'équilibre digestif à toutes les étapes de production. Une attention particulière est portée à la réduction de l\'impact des mycotoxines, à l\'amélioration de la robustesse des jeunes animaux et au maintien d\'une ingestion alimentaire régulière chez les animaux adultes.'],
  ['Our solutions contribute to better growth, improved feed conversion and more stable performance by protecting intestinal integrity and supporting microbial equilibrium. In dairy herds, this also helps maintain milk quality parameters and reduce metabolic disturbances linked to nutritional stress.', 'Nos solutions contribuent à une meilleure croissance, à une conversion alimentaire améliorée et à des performances plus stables en protégeant l\'intégrité intestinale et en soutenant l\'équilibre microbien. Dans les troupeaux laitiers, cela aide également à maintenir les paramètres de qualité du lait et à réduire les troubles métaboliques liés au stress nutritionnel.'],
  ['Thanks to field experience and technical evaluation, we recommend solutions adapted to species category, age stage and production objectives. Each farm has its own constraints, and our role is to identify the most efficient and economically relevant nutritional strategy.', 'Grâce à l\'expérience terrain et à l\'évaluation technique, nous recommandons des solutions adaptées à la catégorie d\'espèce, au stade d\'âge et aux objectifs de production. Chaque élevage a ses propres contraintes, et notre rôle est d\'identifier la stratégie nutritionnelle la plus efficace et économiquement pertinente.'],
  ['How we support aquaculture performance', 'Comment nous soutenons la performance en aquaculture'],
  ['VeritasVet supports fish and shrimp producers with nutritional strategies designed to improve feed utilization, water stability and production consistency under intensive farming conditions.', 'VeritasVet accompagne les producteurs de poissons et de crevettes avec des stratégies nutritionnelles conçues pour améliorer l\'utilisation de l\'aliment, la stabilité de l\'eau et la régularité de production dans des conditions d\'élevage intensif.'],
  ['Our solutions focus on enhancing nutrient digestibility, stabilizing gut microbiota and reducing metabolic stress throughout the production cycle. Particular attention is given to improving feed conversion ratio, supporting immunity and limiting the impact of mycotoxins and raw material variability.', 'Nos solutions se concentrent sur l\'amélioration de la digestibilité des nutriments, la stabilisation du microbiote intestinal et la réduction du stress métabolique tout au long du cycle de production. Une attention particulière est accordée à l\'amélioration de l\'indice de conversion alimentaire, au soutien de l\'immunité et à la limitation de l\'impact des mycotoxines et de la variabilité des matières premières.'],
  ['By optimizing digestion and nutrient absorption, our approach contributes to better growth rates, improved survival and more stable water quality. This helps producers maintain predictable performance while controlling feeding costs and environmental pressure.', 'En optimisant la digestion et l\'absorption des nutriments, notre approche contribue à de meilleurs taux de croissance, une survie améliorée et une qualité d\'eau plus stable. Cela aide les producteurs à maintenir des performances prévisibles tout en maîtrisant les coûts d\'alimentation et la pression environnementale.'],
  ['Our technical team evaluates each farming condition — species, growth stage and production system — to recommend the most efficient and economically relevant nutritional program adapted to your operation.', 'Notre équipe technique évalue chaque condition d\'élevage — espèce, stade de croissance et système de production — afin de recommander le programme nutritionnel le plus efficace et économiquement pertinent, adapté à votre activité.'],
